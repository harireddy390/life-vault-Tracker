          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">
                {initialData ? 'Edit Routine' : 'Add Routine'}
              </h3>
              <p className="text-xs text-slate-500">Your schedule, your flexibility</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1 scrollbar-thin bg-white">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">
              Routine / Activity Name <span className="text-rose-500">*</span>
            </label>
            <input
              type="text"
              value={formData.title}
              onChange={(e) => setFormData({ ...formData, title: e.target.value })}
              placeholder="e.g. Gym, Study, Work, College, Reading, Walk"
          ...
          <div className="pt-3 border-t border-slate-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span>{isSubmitting ? 'Saving...' : initialData ? 'Save Routine' : 'Add Routine'}</span>
              </button>
            </div>
          </div>
        </form>
